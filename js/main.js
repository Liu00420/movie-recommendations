/**********
1. API key: 10bdfcd13094172ecbe658e45f36b60
...
const app = {
    ...
    displayMovies: function (data) {
        ...
        searchMessage.innerHTML = 'The keyward is " ' + app.keyword + ' ". <br>This is the page ' + app.currentPage + '.&nbsp&nbsp Total pages: ' + app.totalPages + '.';
    ...
    makePagination: function () {
        ...
        pageInput.setAttribute('placeholder', 'page #')
